            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label"> Customer Management <span class="d-block text-muted pt-2 font-size-sm"></span>
                        </h3>
                    </div>
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        ...
                        <tbody>
                            ...
                            <td>{{isset($user->mobile_no) ? $user->mobile_no : ''}}</td>
                                <td>
                                    <a href="{{route('admin.edit_user',$user->id)}}" class="btn edit_pro btn-success btn-sm">Edit</a>
